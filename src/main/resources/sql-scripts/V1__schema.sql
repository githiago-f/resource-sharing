...
ALTER TABLE TRAB_RECURSOS ADD CONSTRAINT TRAB_FK_ID_INSTITUICAO_RECURSO
FOREIGN KEY(ID_INSTITUICAO) REFERENCES TRAB_INSTITUICOES;
...
ALTER TABLE TRAB_INSTANCIAS ADD CONSTRAINT FK_ID_PROGRAMA_INSTANCIA FOREIGN KEY(ID_PROGRAMA) REFERENCES TRAB_PROGRAMAS;
...
ALTER TABLE TRAB_FILAS ADD CONSTRAINT TRAB_FK_ID_INSTANCIA_FILA FOREIGN KEY(ID_INSTANCIA) REFERENCES TRAB_INSTANCIAS;
...
ALTER TABLE TRAB_ALUNOS_FILA ADD CONSTRAINT TRAB_FK_ID_ALUNO_FILA FOREIGN KEY(ID_USUARIO) REFERENCES TRAB_ALUNOS;

ALTER TABLE TRAB_ALUNOS_FILA ADD CONSTRAINT TRAB_FK_ID_FILA_ALUNO FOREIGN KEY(ID_FILA) REFERENCES TRAB_FILAS;
...
ALTER TABLE TRAB_ALUNO_FILA_INSTANCIA ADD CONSTRAINT TRAB_FK_ID_AF_INSTANCIA
FOREIGN KEY(ID_ALUNO_FILA) REFERENCES TRAB_ALUNOS_FILA;

ALTER TABLE TRAB_ALUNO_FILA_INSTANCIA ADD CONSTRAINT TRAB_FK_ID_INSTANCIA_ALUNO
FOREIGN KEY(ID_INSTANCIA) REFERENCES TRAB_INSTANCIAS;